...
in_maf=menieres.531.filtered.08222022.tsv

# Convert filtered variants back to VCF
maf2vcf.pl --input-maf $workspace/$in_maf --output-dir $workspace --output-vcf $workspace/menieres.531.filtered.vcf --ref-fasta $genome_fasta
