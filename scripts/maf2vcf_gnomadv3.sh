...
maf2vcf.pl --input-maf $workspace/menieres.531.filtered.tsv --output-dir $workspace --output-vcf $workspace/menieres.531.filtered.vcf --ref-fasta /shared/workspace/software/bcbio/genomes/Hsapiens/hg38/seq/hg38.fa
...
bcftools sort \
-T $workspace -Oz -o $workspace/menieres.531.gnomadv3.vcf.gz
